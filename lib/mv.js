var mv = (function () {
    ...
    return {
        ...
        actionVersionFormatter: (value, row, index) => {
            return `
                <a onclick="mv.changeVersion('${row.id}', '${value}')"><i class="ri-eye-2-line"></i></a>
                <a onclick="mv.deleteVersion('${row.id}', '${value}')"><i class="ri-delete-bin-2-line"></i></a>
            `;
        ...
        appsTableToolbar: () => {
            ...
            const btns = [{
                ...
                id: "createVersionBtn",
                click: 'mv.createVersion(config.id)'
            }, {
                text: "Recharger",
