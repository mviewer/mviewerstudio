var mv = (function () {
    ...
    return {
        ...
        actionVersionFormatter: (value, row, index) => {
            const flag = `<a id="versionVersionIcon"><i class="ri-flag-2-line"></i></a>`
            return `
                ...
                <a id="versionAsNewLink" onclick="mv.changeVersion('${config.id }', '${ row.id}', true)"><i class="ri-arrow-go-back-fill"></i></a>
                ${row?.version ? flag : ""}
            `;
