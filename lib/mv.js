var mv = (function () {
    ...
    return {
        ...
        showLayerOptions: function (el) {
            ...
            document.querySelector("#frm-legend").value = layer?.legendurl ? "custom" : "default";
        ...
        writeLayerNode: function (l) {
            ...
            if (l.templateurl && l.useexternaltemplate) {
                ...
                template = '<template url="' + _conf.conf_path_from_mviewer + l.generatorTemplateUrl + '" ></template>';
            }
        ...
        parseApplication(xml, idRecognized) {
            const app_identifier = idRecognized ? xml.getElementsByTagName("dc:identifier")[0]?.innerHTML : "";
            const app_keywords = xml.getElementsByTagName("dc:keywords")[0]?.innerHTML;
            const dateXml = idRecognized ? xml.getElementsByTagName("dc:date")[0]?.innerHTML : "";
            const relation = idRecognized ? xml.getElementsByTagName("dc:relation")[0]?.innerHTML : "";
