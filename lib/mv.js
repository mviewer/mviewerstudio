    ...
    return {
        ...
        showFields: function (fields, layerid) {
            ...
            $(fields).each(function (id, fld) {
                ...
                var item = [
                    '<div class="list-group-item row fld '+selected+'" data-field="'+fld+'" >',
                        '<span class="glyphicon glyphicon-move pull-left" aria-hidden="true"></span>',
        ...
        changeSearchLocalities: function (value) {
            switch (value) {
                ...
                case "ban":
                    ...
                    $("#opt-searchlocalities-attribution").val('IGN - BAN');
                    break;
                case  "geoportail":
                    $("#opt-searchlocalities-url").val("");
                    $("#opt-searchl-url").show();
