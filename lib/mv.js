var mv = (function () {
    ...
    return {
        ...
        showLayerOptions: function (el) {
            ...
            // new
            $("#frm-layer-index").prop("checked", layer?.index);
        ...
        saveLayerOptions: function (layerid = null) {
            ...
            layer["index"] = document.querySelectorAll(`#themeLayers .layers-list-item[data-layerid='${ layerid }'] .index-selector`)[0].value;
        ...
        writeLayerNode: function (l) {
            ...
            var layer_parameters = {};
                ...
                optional_parameters.forEach(param => {
                    ...
                    if (param == "index") {
                        value = document.querySelectorAll(`#themeLayers .layers-list-item[data-layerid='${ l.id }'] .index-selector`)[0].value;
                    }
