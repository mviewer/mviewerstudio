        ...
        showListApplications(data, search) {
            ...
            data
                ...
                .forEach((app) => {
                    ...
                    let badgeLabel = app.publish ? mviewer.tr("publish") : mviewer.tr("draft");
                    let badgeColor = app.publish ? "badge-publish" : "badge-draft";
                    const badge = `<span class="badge ${badgeColor}">${badgeLabel}</span>`
                    const items = `
        ...
        showPublishModal: (shareLink = "", iframeLink = "") => {
            ...
            genericModalContent.innerHTML = `
                ...
                <div class="modal-body">
                    ...
                    <a class="cardsClose save-close zoomCard" data-bs-dismiss="modal">
