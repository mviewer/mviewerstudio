var mv = (function () {
  ...
  return {
    ...
    getConfGroups: function () {
      ...
      addGroup(themeid, groupTitle, groupId);
    },
    ...
    writeGroupNode: function (g) {
      ...
      var groupParameters = {};
      //require parameters
      var requireParameters = ["id", "title"];
    ...
    parseApplication(xml, idRecognized) {
      ...
      themes.each(function (id, th) {
        ...
        // Ajout des groupes et de leurs layers
        ...
        groups.each((id, g) => {
          ...
          addGroup($(th).attr("id"), group.title, group.id);
          ...
          if (layers)
            layers.each(function (id, l) {
              ...
              if (
                !config.themes[$(th).attr("id")].groups.find((group) => group.id).layers
              )
                config.themes[$(th).attr("id")].groups.find((group) => group.id).layers =
                  [];
              config.themes[$(th).attr("id")].groups
