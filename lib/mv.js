var mv = (function () {
    ...
    return {
        ...
        showLayerOptions: function (el) {
            ...
            // new
            $("#frm-layer-styletitle").val(layer?.attribution || "");
            $("#frm-layer-dynamiclegend").val(layer?.dynamiclegend || "");
            $("#frm-layer-exclusive").val(layer?.exclusive || "");
            $("#frm-layer-toplayer").val(layer?.toplayer || "");
            $("#frm-layer-showintoc").val(layer?.showintoc || "");
        ...
        saveLayerOptions: function () {
            ...
            layer["dynamiclegend"] = $("#frm-layer-dynamiclegend").val();
            layer["exclusive"] = $("#frm-layer-exclusive").val();
            layer["toplayer"] = $("#frm-layer-toplayer").val();
            layer["showintoc"] = $("#frm-layer-showintoc").val();
