var mv = (function () {
    ...
    return {
        ...
        validateFormBaseLayer: (event) => {
            // Test input value
            [...appCustomBackgroundBlock.querySelectorAll("div:not(.d-none) > div > input[required]")].forEach(function(e){
                if (e.value == "") {
            ...
            mv.addBaseLayer();  
            // Reset input      
            [...appCustomBackgroundBlock.querySelectorAll("input")].forEach(function(e){
                e.value = "";
