...
export default class InputTagsComponent {
    ...
    values = [];
    placeholder = ""
    constructor(divId, fields, options = "", selector = "componentsTagsSelector", placeholder) {
        this.divId = divId;
        this.fields = fields;
    ...
    render = () => `<select class="form-control form-select form-control-sm component-form ${this.selector}" id="${this.uuid}" name="tags[]" multiple ${this.options}>
