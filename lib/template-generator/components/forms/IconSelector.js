    ...
    render = () => {
        ...
        <div class="row g-3 align-items-center">
            <div class="form-group" id="formIconGrp-${this.uuid}">
                <label id="iconInputComponent-${this.uuid }" for="iconComponent-${ this.uuid}" class="form-label">
                ...
                <div class="d-flex">
                    ...
                    <button
                        class="btn btn-outline-info picker-button"
                        type="button"
                    ...
                    <button
                        class="btn btn-danger cearIcon d-none"
                        type="button"
