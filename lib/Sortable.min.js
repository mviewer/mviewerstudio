...
!(function (a) {
      ...
      do
        if (
          ...
          (("" === d || a.nodeName.toUpperCase() == d) &&
            (!b.length || ((" " + a.className + " ").match(e) || []).length == b.length))
        )
          return a;
  ...
  function n(a, b) {
    ...
    return (
      (b.clientY - (d.top + d.height) > 5 || b.clientX - (d.right + d.width) > 5) && c
    );
  }
  function o(a) {
    for (
    ...
    U = q(function (a, b, c) {
      if (c && b.scroll) {
        ...
        if (z !== c && ((y = b.scroll), (z = c), y === !0)) {
          y = c;
          do if (y.offsetWidth < y.scrollWidth || y.offsetHeight < y.scrollHeight) break;
  ...
  return (
    (a.prototype = {
        ...
        if (
          ...
          if (((D = p(h)), "function" == typeof k)) {
            ...
            (k = k.split(",").some(function (a) {
              return (
                (a = c(i, a.trim(), d)), a ? (j(b, a, "filter", h, d, D), !0) : void 0
              );
            }))
          )
      ...
      _onDragStart: function (a, b) {
        ...
        this._offUpEvents(),
          "clone" == F.pull &&
            ((v = s.cloneNode(!0)), h(v, "display", "none"), w.insertBefore(v, s)),
          b
            ? ("touch" === b
                ? (e(N, "touchmove", this._onTouchMove),
                  e(N, "touchend", this._onDrop),
                  e(N, "touchcancel", this._onDrop))
                : (e(N, "mousemove", this._onTouchMove), e(N, "mouseup", this._onDrop)),
              (this._loopId = setInterval(this._emulateDragOver, 50)))
            : (c && ((c.effectAllowed = "move"), d.setData && d.setData.call(this, c, s)),
              e(N, "drop", this),
      ...
      _onDragOver: function (a) {
        ...
        if (
          ...
          if (((d = c(a.target, i.draggable, g)), (e = s.getBoundingClientRect()), f))
            return (
              b(!0), void (v || x ? w.insertBefore(s, v || x) : p || w.appendChild(s))
            );
          if (
            0 === g.children.length ||
            g.children[0] === u ||
            ...
            var q,
              ...
              H = (D ? (a.clientX - r.left) / y : (a.clientY - r.top) / z) > 0.5,
            ...
            if (K !== !1) {
              ...
              s.contains(g) ||
                (q && !J ? g.appendChild(s) : d.parentNode.insertBefore(s, q ? J : d)),
                (t = s.parentNode),
                this._animate(e, s),
                this._animate(r, d);
            }
